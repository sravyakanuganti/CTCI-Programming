...
public class CheckPermutation {
	 ...
	 * of occurrences of that char is not the same), return false. Else, decrement the count, add to the 
	 * table and continue. Return true when all characters are checked.
	 * 
